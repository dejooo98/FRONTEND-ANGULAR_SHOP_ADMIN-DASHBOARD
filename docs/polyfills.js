  ...
  \***********************************************/
      /***/ () => {
          ...
          class ZoneDelegate {
            constructor(zone, parentDelegate, zoneSpec) {
              ...
              this._handleErrorCurrZone =
                zoneSpec &&
                (zoneSpec.onHandleError ? this.zone : parentDelegate._handleErrorCurrZone);
              ...
              this._cancelTaskCurrZone =
                zoneSpec &&
                (zoneSpec.onCancelTask ? this.zone : parentDelegate._cancelTaskCurrZone);
        ...
        function isPropertyWritable(propertyDesc) {
          ...
          return !(
            typeof propertyDesc.get === 'function' && typeof propertyDesc.set === 'undefined'
          );
        }
        const isWebWorker =
        ...
        Zone.__load_patch('ZoneAwarePromise', (global, Zone, api) => {
          ...
          class ZoneAwarePromise {
            ...
            constructor(executor) {
              ...
              try {
                executor &&
                  executor(makeResolver(promise, RESOLVED), makeResolver(promise, REJECTED));
              } catch (error) {
        ...
        Zone.__load_patch('PromiseRejectionEvent', (global, Zone) => {
          ...
          if (global['PromiseRejectionEvent']) {
            ...
            Zone[zoneSymbol('rejectionHandledHandler')] = findPromiseRejectionHandler(
              'rejectionhandled'
            );
          }
        });
